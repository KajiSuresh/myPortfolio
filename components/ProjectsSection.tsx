...
const projects = [
  {
    ...
    github: 'https://github.com/KajiSuresh/smartcity_j.git',
    featured: true,
  },
  {
    id: 2,
    title: 'SmartWaste Collection',
    description: 'A concise solution for managing garbage collection across urban areas, optimizing routes, improving efficiency, and ensuring timely, organized waste management services.',
    tech: ['React', 'Firebase', 'Tailwind CSS', 'Next JS', 'Flutter'],
    image: '🏡',
    link: 'https://github.com/KajiSuresh/garbage-mobile.git',
    github: 'https://github.com/KajiSuresh/garbage-admin.git',
    featured: true,
  },
  {
    id: 3,
    title: 'NavCity - City Guide',
    description: 'Smart tips, curated information, and local insights to help you move through the city effortlessly.',
    tech: ['Next.js', 'PostgreSQL', 'React' , 'Shade CN'],
    image: '🏨',
    link: 'https://smartcity-wine.vercel.app/',
    github: 'https://github.com/KajiSuresh/smartcity.git',
    featured: true,
  },
  // {
  //   id: 4,
